...
/* Zios Coin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "ZiosCoin"
#define QAPP_ORG_DOMAIN "savebitcoin.io"
#define QAPP_APP_NAME_DEFAULT "ZiosCoin-Qt"
#define QAPP_APP_NAME_TESTNET "ZiosCoin-Qt-testnet"
