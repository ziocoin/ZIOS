...
/** Utility functions used by the ZiosCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render ZIOS addresses in monospace font
...
// Parse "zioscoin:" URI into recipient object, return true on successful parsing
