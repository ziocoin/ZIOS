...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Zios Coin Core zioscoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  zioscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded zios coin transaction") + "\n" +
                               "  zioscoin-tx [options] -create [commands]   " + _("Create hex-encoded zios coin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded zios coin transaction
