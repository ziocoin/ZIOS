...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Zios Coin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Zios Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Zios Coin features */
        {"zioscoin", "masternode", &masternode, true, true, false},
        {"zioscoin", "listmasternodes", &listmasternodes, true, true, false},
        {"zioscoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"zioscoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"zioscoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"zioscoin", "masternodedebug", &masternodedebug, true, true, false},
        {"zioscoin", "startmasternode", &startmasternode, true, true, false},
        {"zioscoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"zioscoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"zioscoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"zioscoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"zioscoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"zioscoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"zioscoin", "mnbudget", &mnbudget, true, true, false},
        {"zioscoin", "preparebudget", &preparebudget, true, true, false},
        {"zioscoin", "submitbudget", &submitbudget, true, true, false},
        {"zioscoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"zioscoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"zioscoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"zioscoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"zioscoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"zioscoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"zioscoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"zioscoin", "checkbudgets", &checkbudgets, true, true, false},
        {"zioscoin", "mnsync", &mnsync, true, true, false},
        {"zioscoin", "spork", &spork, true, true, false},
        {"zioscoin", "preparecommunityproposal", &preparecommunityproposal, true, true, false},
        {"zioscoin", "submitcommunityproposal", &submitcommunityproposal, true, true, false},
        {"zioscoin", "getcommunityinfo", &getcommunityinfo, true, true, false},
        {"zioscoin", "checkcommunityproposals", &checkcommunityproposals, true, true, false},
        {"zioscoin", "getcommunityproposalvotes", &getcommunityproposalvotes, true, true, false},
        {"zioscoin", "mncommunityvote", &mncommunityvote, true, true, false},
...
{
    return "> zioscoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9156/\n";
}
