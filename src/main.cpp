...
#if defined(NDEBUG)
#error "Zios Coin cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    else if (nHeight > 200 && nHeight <=  133571428571)
        nSubsidy = 1.4 * COIN;
    else if (nHeight = 133571428572)
        nSubsidy = 0.6 * COIN;
    else
        nSubsidy = 0 * COIN;
...
{
    RenameThread("zioscoin-scriptch");
