Contributing to Zios Coin Core
==================================

The Zios Coin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Zios Coin Core project, and is not to be
confused with overall Zios Coin Network Protocol consensus changes.

Whether a pull request is merged into Zios Coin Core rests with the project merge
...
Patches that change Zios Coin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Zios Coin consensus, it must have been
...
The project leader is the release manager for each Zios Coin Core release.
