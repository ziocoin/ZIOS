...
In order to support loading of multiple wallets in zioscoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zioscoin.cpp.
...
Changes to zioscoin.cpp
----------------------
zioscoin.cpp is the entry point into zioscoin-qt, and as such, will require some minor modifications to provide hooks for
