...
Intro
-----
Zios Coin (ZIOS) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Zios Coin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run zioscoin-qt.exe.

Zios Coin Core is the original Zios Coin client and it builds the backbone of the network.
However, it downloads and stores the entire history of Zios Coin transactions;
