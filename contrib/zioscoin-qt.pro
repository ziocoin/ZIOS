...
RESOURCES += src/qt/zioscoin.qrc src/qt/zioscoin_locale.qrc

TRANSLATIONS += src/qt/locale/zioscoin_bg.ts \
                src/qt/locale/zioscoin_de.ts \
                src/qt/locale/zioscoin_en.ts \
                src/qt/locale/zioscoin_es.ts \
                src/qt/locale/zioscoin_fi.ts \
                src/qt/locale/zioscoin_fr.ts \
                src/qt/locale/zioscoin_it.ts \
                src/qt/locale/zioscoin_ja.ts \
                src/qt/locale/zioscoin_pl.ts \
                src/qt/locale/zioscoin_pt.ts \
                src/qt/locale/zioscoin_ru.ts \
                src/qt/locale/zioscoin_sk.ts \
                src/qt/locale/zioscoin_sv.ts \
                src/qt/locale/zioscoin_vi.ts \
                src/qt/locale/zioscoin_zh_CN.ts \
                src/qt/locale/zioscoin_zh_TW.ts
